                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Transaksi Obat Masuk</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Transaksi</a></li>
                            <li class="breadcrumb-item"><a href="#!">Obat Masuk</a></li>
                            <li class="breadcrumb-item"><a href="#!">Transaksi Obat Masuk</a></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="col-xl-12">
                <div class="card">
                    ...
                    <div class="card-body table-border-style">
                        ...
                        ?>
                        <form method="post" action="<?= base_url() ?>obat_masuk/checkout">
                            <div class="row">
                                <div class="col-md-4">
                                    <label for="">Kode Transaksi</label>
                                    <input type="text" class="form-control" name="kode" value="<?= strtoupper('TOM' . random_string('alnum', 3)); ?><?= date('Hi') ?>" readonly>
                                </div>
                                <div class="col-md-4">
                                ...
                                <tbody>
                                    <?php foreach ($this->cart->contents() as $key => $items): ?>
                                        <tr>
                                            ...
                                            <td width="10%">
                                                <a href="<?= base_url() ?>obat_masuk/hapuskeranjang?rowid=<?=$items['rowid'];?>&qty=0" class="btn btn-danger hapus-keranjang"><i class="feather icon-trash"></i> Hapus</a>
                                            </td>
                                        </tr>
                                    <?php endforeach ?>
                                </tbody>
                            ...
                            <a href="<?= base_url() ?>obat_masuk/batal" class="btn btn-danger"><i class="fa fa-times"></i> Batal</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url() ?>obat_masuk/masukankeranjang" method="post">
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="jumlah">Tanggal Expired</label>
