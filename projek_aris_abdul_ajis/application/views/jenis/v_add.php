                ...
                <div class="row align-items-center">
                    <div class="col-md-12">
                        <div class="page-header-title">
                            <h5 class="m-b-10">Tambah Jenis Obat</h5>
                        </div>
                        <ul class="breadcrumb">
                            <li class="breadcrumb-item"><a href="index.html"><i class="feather icon-home"></i></a></li>
                            <li class="breadcrumb-item"><a href="#!">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="#!">Data Jenis Obat</a></li>
                            <li class="breadcrumb-item"><a href="#!">Tambah Jenis Obat</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body table-border-style">
                        <form action="<?= base_url() ?>jenis/add" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input id="nama_jenis" class="form-control" type="text" name="nama_jenis" placeholder="Nama Jenis Obat" required>
                            </div>
                            <hr>
